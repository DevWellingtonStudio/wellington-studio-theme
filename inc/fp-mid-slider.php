	  ...
	  <div class="carousel-inner">
	    <div class="carousel-item active">
	      ...
	      <div class="carousel-caption d-none d-md-block">
	        <h5><?php if($midslider1title !== $default){echo $midslider1title;} ?></h5>
	    ...
	    <div class="carousel-item">
	      ...
	      <div class="carousel-caption d-none d-md-block">
	        <h5><?php if($midslider2title !== $default){echo $midslider2title;} ?></h5>
	    ...
	    <div class="carousel-item">
	      ...
	      <div class="carousel-caption d-none d-md-block">
	        <h5><?php if($midslider3title !== $default){echo $midslider3title;} ?></h5>
